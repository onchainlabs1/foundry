...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  * {
  ...
  --tw-bg-opacity: 1;
  background-color: rgb(11 31 59 / var(--tw-bg-opacity, 1));
  padding-left: 1rem;
  padding-right: 1rem;
  padding-top: 0.5rem;
...
.btn-primary:focus {
  ...
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(11 31 59 / var(--tw-ring-opacity, 1));
...
.btn-secondary {
  ...
  font-weight: 600;
  --tw-text-opacity: 1;
  color: rgb(11 31 59 / var(--tw-text-opacity, 1));
...
.bg-navy\/10 {
  background-color: rgb(11 31 59 / 0.1);
}
.bg-orange-50 {
  --tw-bg-opacity: 1;
...
.from-navy {
  --tw-gradient-from: #0B1F3B var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(11 31 59 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-navy\/5 {
  --tw-gradient-from: rgb(11 31 59 / 0.05) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(11 31 59 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-slate-50 {
...
.via-navy {
  --tw-gradient-to: rgb(11 31 59 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #0B1F3B var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-soft-green {
  --tw-gradient-to: rgb(16 185 129 / 0)  var(--tw-gradient-to-position);
...
.to-navy\/80 {
  --tw-gradient-to: rgb(11 31 59 / 0.8) var(--tw-gradient-to-position);
}
.to-navy\/90 {
  --tw-gradient-to: rgb(11 31 59 / 0.9) var(--tw-gradient-to-position);
}
.to-soft-green\/20 {
...
.hover\:from-navy\/90:hover {
  --tw-gradient-from: rgb(11 31 59 / 0.9) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(11 31 59 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.hover\:from-soft-green\/90:hover {
...
.hover\:to-navy:hover {
  --tw-gradient-to: #0B1F3B var(--tw-gradient-to-position);
}

.hover\:to-soft-green:hover {
...
.group:hover .group-hover\:bg-soft-green\/20 {
  background-color: rgb(16 185 129 / 0.2);
}

.group:hover .group-hover\:text-soft-green {
  --tw-text-opacity: 1;
  color: rgb(16 185 129 / var(--tw-text-opacity, 1));
}
