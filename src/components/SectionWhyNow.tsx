              ...
              <li className="flex items-start">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[11px] font-medium border border-slate-300 text-slate-900 dark:border-slate-600 dark:text-slate-100">
